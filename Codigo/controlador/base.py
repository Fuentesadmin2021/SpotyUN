    ...
    def actualizar_info_tablas(self, nombre_columna: str, nombre_tabla: str, primary_key: str, info = "indefinido"):
        ...
        while state:
            try:
                ...
                if id_v := validacion_existencia_todas(self.__con, nombre_tabla, nombre_columna, primary_key, id) == False:
                    id = int(id)
                    state = False
        ...
        while reproducir:
            try:
                ...
                if opcion =="p":
                    ...
                    Canciones.get_cancion(self)
                    id_validacion = validacion_existencia_todas(self.__con, 'listas', 'id_cancion', 'id_cancion', self.__id)
...
class Planes():
    ...
    def consulta_plan(self):
        try:
            ...
            datos = ("\n{:<5} {:<15} {:<10} {:<10} ".format(self.__id, self.__nombre, self.__valor, self.__cant_canciones))
            print(cabecero, datos)
        except ValueError:
            print("\n El id ingresado no es valido")
    ...
    def consulta_planes(self, tupla):
        ...
        for row in tupla:
            ...
            self.__valor = row[2]
            self.__cant_canciones = row[3]
            print ("{:<5} {:<15} {:<10} {:<10} ".format(self.__id, self.__nombre, self.__valor, self.__cant_canciones))
    ...
    def actualizar_info_plan(self):
        ...
        while not salir_actualizar:
            ...
            if (opc == '1'):
                ...
                Planes.set_cant_canciones(self)
                Planes.actualizar_info_tablas(self, info = self.__cant_canciones, nombre_tabla = 'planes', nombre_columna = 'nombre_plan', primary_key = 'id_plan')
...
class Cliente():
    ...
    def set_id(self):
        ...
        validacion = validacion_existencia_todas(self.__con, nombre_tabla = 'clientes', nombre_columna = 'id_cliente', primary_key = 'id_cliente', id = self.__id)
        while validacion == False:
...
class PP_clientes(Planes):
    ...
    def armar_tupla(self):
        ...
        plan_cliente = (self.__id_plan_c,)
        return plan_cliente


# d_cliente = Cliente(con)
# p_cliente = PP_clientes(con)
# dd_cliente = d_cliente.armar_tupla()
# pp_cliente = (d_cliente.get_id(), p_cliente.armar_tupla())
